...
vnet_address_space   = "<10.0.0.0/16>" // Enter the vnet address to create the webapp
subnet_name          = "<myapp_subnet>" // Enter the existing/Create Azure sub network name to create the webapp
subnet_address_space = "<10.0.2.0/24>" // Enter the subnetnet address to create the webapp
ni_name              = "<myapp_ni>"  // Enter the existing/Create Azure network interface name to create the webapp
ip_config_name       = "<myapp_ip> // Enter the existing/Create Azure ip configuration name to create the webapp
...
slot_names           = ["uat"] // Enter the Create Azure app service slots  name to create the webapp
